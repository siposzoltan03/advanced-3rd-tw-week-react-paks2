  ...
  useEffect(() => {
    if (
      ...
      Object.keys(cityTwo).length === 14
			...
			cityOneCopy["housing"][greater] = cityOneCopy["housing"][score] > cityTwoCopy["housing"][score];
			cityTwoCopy["housing"][greater] = !cityOneCopy["housing"][greater];

			cityOneCopy["costOfLiving"][greater] = cityOneCopy["costOfLiving"][score] > cityTwoCopy["costOfLiving"][score];
			cityTwoCopy["costOfLiving"][greater] = !cityOneCopy["costOfLiving"][greater];

			cityOneCopy["travelConnectivity"][greater] = cityOneCopy["travelConnectivity"][score] > cityTwoCopy["travelConnectivity"][score];
			cityTwoCopy["travelConnectivity"][greater] = !cityOneCopy["travelConnectivity"][greater];

			cityOneCopy["safety"][greater] = cityOneCopy["safety"][score] > cityTwoCopy["safety"][score];
			cityTwoCopy["safety"][greater] = !cityOneCopy["safety"][greater];

			cityOneCopy["internetAccess"][greater] = cityOneCopy["internetAccess"][score] > cityTwoCopy["internetAccess"][score];
			cityTwoCopy["internetAccess"][greater] = !cityOneCopy["internetAccess"][greater];

			cityOneCopy["environmentalQuality"][greater] = cityOneCopy["environmentalQuality"][score] > cityTwoCopy["environmentalQuality"][score];
			cityTwoCopy["environmentalQuality"][greater] = !cityOneCopy["environmentalQuality"][greater];

			cityOneCopy["leisureAndCulture"][greater] = cityOneCopy["leisureAndCulture"][score] > cityTwoCopy["leisureAndCulture"][score];
			cityTwoCopy["leisureAndCulture"][greater] = !cityOneCopy["leisureAndCulture"][greater];
